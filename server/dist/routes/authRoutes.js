...
router.post('/login-2fa', authLimiter, authController_1.completeLoginWithTwoFactor);
router.get('/logout', authController_1.logout);
router.get('/login-history', auth_1.protect, authController_1.getLoginHistory);
router.post('/2fa/setup', auth_1.protect, authController_1.setupTwoFactor);
router.post('/2fa/enable', auth_1.protect, authController_1.enableTwoFactor);
router.post('/2fa/disable', auth_1.protect, authController_1.disableTwoFactor);
