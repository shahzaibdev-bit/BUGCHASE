    ...
    <div className={cn('flex items-center gap-3 cursor-pointer group', className)}>
      ...
      {showText && (
        <div className="flex flex-col">
          ...
          >
            Bug
            <span className="text-zinc-900 dark:text-white drop-shadow-sm dark:drop-shadow-[0_0_5px_rgba(255,255,255,0.5)]">
              CHASE
            </span>
          </span>
        </div>
...
const BugSvg = ({ strokeWidth = 1.5, ...props }: React.SVGProps<SVGSVGElement>) => (
  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" {...props} strokeWidth={strokeWidth}>
    <path d="M8 3v2" />
    <path d="M16 3v2" />
    <path d="M9 5l-2-2" />
    <path d="M15 5l2-2" />
    <path d="M12 5l3 2v4l-3 2-3-2V7z" />
    <path d="M12 13l3.5 1.5v4l-3.5 2.5-3.5-2.5v-4z" />
    <path d="M9 8H6l-2 3" />
    <path d="M15 8h3l2 3" />
    <path d="M9 11H5l-1 4" />
    <path d="M15 11h4l1 4" />
